...
<div class=" px-6 py-6">
    <h1 class="text-lg text-indigo-500 font-semibold">Item List</h1>
</div>
<div class="mt-4 px-6">
    @if (session('message'))
...
<div class="px-6 py-6">
    <a href="{{route('item#createPage')}}" class="bg-indigo-500 hover:bg-indigo-400 space-x-4 rounded-lg float-right px-4 py-2 text-white">
              ...
              <table class="min-w-full">
                <thead class=" border-b bg-indigo-500">
                  <tr class="text-white">
                    ...
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                      items <i class="fa-solid fa-chevron-down text-sm ml-2"></i>
                    </th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                      Category <i class="fa-solid fa-chevron-down text-sm ml-2"></i>
                    </th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                        Description <i class="fa-solid fa-chevron-down text-sm ml-2"></i>
                    </th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                        Price <i class="fa-solid fa-chevron-down text-sm ml-2"></i>
                    </th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                        Owner <i class="fa-solid fa-chevron-down text-sm ml-2"></i>
                    </th>
                    <th scope="col" class="text-sm font-medium text-white px-6 py-4 text-left">
                ...
                <tbody id="rowChange">
                  ...
                  <tr class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">
                        <div class="">
                            <a href="{{route('item#edit',$i->id)}}" class="bg-green-500 hover:bg-green-400 p-2 rounded-lg"><i class="fa-regular fa-pen-to-square text-lg "></i></a>
                            <a href="{{ route('item#delete',$i->id) }}" class="bg-red-500 hover:bg-red-400 p-2 rounded-lg"><i class="fa-regular fa-trash-can text-lg"></i></a>
                        </div>
                    </td>
    ...
    $(document).ready(function(){
        ...
        $('#rowSelect').change(function(){
            ...
            if($eventValue == '10'){
                ...
                $.ajax({
                    type : 'get',
                    url : 'http://localhost:8000/item/row/select',
                    data : $row,
                    dataType : 'json',
